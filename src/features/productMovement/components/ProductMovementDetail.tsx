        ...
        <Dialog open={open} onOpenChange={setOpen}>
            ...
            <DialogContent className="bg-white overflow-y-auto max-h-[90%] min-h-[90%] md:min-h-auto">
                <div className="grid gap-0 grid-cols-1">
                    ...
                    {
                        initialData && initialData?.booking && <div>
                            <Collapsible className="group/collapsible border rounded-md mb-2">
                                ...
                                <CollapsibleContent className="grid grid-cols-1 p-4 gap-2 border-t">
                    ...
                    <div className="grid grid-cols-1 p-4 gap-2 border rounded-md">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div className="flex flex-col gap-0">
